...
public class authenticate : IHttpHandler {
    ...
    protected String upath = "App_Code/script/ui-framework/production";

    /* site authorization */
    protected string siteAuthorization = "ui-framework";
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        obAnyTrackerData.trackerCategory = obAnyTrackerData.uiFrameworkRequestInit;
    ...
    private void returnSuccess(object iData) {
        ...
        obAnyTrackerData.trackerName = thisPageURL;
        obAnyTrackerData.trackerValue = new JavaScriptSerializer().Serialize(obTrackerValue);
        obAnyTrackerData.trackerCategory = obAnyTrackerData.uiFrameworkRequestSuccess;
        obAnyTrackerAPI.addTracker(obAnyTrackerData);
        ...
        HttpContext.Current.Response.AddHeader(obAnyTrackerData.uiFrameworkRequestSuccess, requestInitData.requestURL);
    ...
    private void returnFail(SortedDictionary<string,string> iData) {
        ...
        obAnyTrackerData.trackerName = thisPageURL;
        obAnyTrackerData.trackerValue = new JavaScriptSerializer().Serialize(obTrackerValue);
        obAnyTrackerData.trackerCategory = obAnyTrackerData.uiFrameworkRequestFailed;
        obAnyTrackerAPI.addTracker(obAnyTrackerData);
        ...
        HttpContext.Current.Response.AddHeader(obHeaderInfoData.requestAgent, requestInitData.requestClient);
        HttpContext.Current.Response.AddHeader(obHeaderInfoData.requestURL, requestInitData.requestURL);
        HttpContext.Current.Response.AddHeader(obAnyTrackerData.uiFrameworkRequestFailed, requestInitData.requestURL);
