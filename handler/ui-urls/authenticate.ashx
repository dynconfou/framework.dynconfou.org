...
public class authenticate : IHttpHandler {
    ...
    protected String upath = "App_Code/script/ui-urls/production";

    /* site authorization */
    protected string siteAuthorization = "ui-urls";
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        obAnyTrackerData.trackerCategory = obAnyTrackerData.uiUrlsRequestInit;
    ...
    private void returnSuccess(object iData) {
        ...
        obAnyTrackerData.trackerName = thisPageURL;
        obAnyTrackerData.trackerValue = new JavaScriptSerializer().Serialize(obTrackerValue);
        obAnyTrackerData.trackerCategory = obAnyTrackerData.uiUrlsRequestSuccess;
        obAnyTrackerAPI.addTracker(obAnyTrackerData);
        ...
        HttpContext.Current.Response.AddHeader(obAnyTrackerData.uiUrlsRequestSuccess, requestInitData.requestURL);
    ...
    private void returnFail(SortedDictionary<string,string> iData) {
        ...
        obAnyTrackerData.trackerName = thisPageURL;
        obAnyTrackerData.trackerValue = new JavaScriptSerializer().Serialize(obTrackerValue);
        obAnyTrackerData.trackerCategory = obAnyTrackerData.uiUrlsRequestFailed;
        obAnyTrackerAPI.addTracker(obAnyTrackerData);
