...
public class authenticate : IHttpHandler {
    ...
    protected String upath = "App_Code/script/integration/ui-css-structure/production";

    /* site authorization */
    protected string siteAuthorization = "ui-css-structure-integration";
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        /* auth init data */
        obReQuestTrackerData.trackerName = obReQuestTrackerStatic.authenticateUICSSStructureIntegration;
