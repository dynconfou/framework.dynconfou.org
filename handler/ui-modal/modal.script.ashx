...
public class authenticate : IHttpHandler {
    ...
    protected String upath = "App_Code/templates/ui-modal/javascript/production";

    /* site authorization */
    protected string siteAuthorization = "ui-modal-script";
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        /* auth init data */
        obReQuestTrackerData.trackerName = obReQuestTrackerStatic.authenticateUIModalScript;
